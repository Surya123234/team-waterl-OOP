...
interface TripDao {
    ...
    @Query("SELECT * FROM trips WHERE locallyDeleted = 0 ORDER BY CASE status WHEN 'active' THEN 1 WHEN 'planned' THEN 2 WHEN 'completed' THEN 3 ELSE 4 END, updatedAt DESC")
